    ...
    <div class="form-add-book mt-4 px-3 px-lg-4 pb-5 rounded">
        ...
        <div class="row justify-content-center justify-content-md-start">
            <div class="col-auto">
                ...
                <button type="button" id="cancel-edit" class="btn btn-danger fw-medium px-4 w-auto">Hủy</button>
            </div>    
        </div>
    </div>
    
    <script type="text/javascript" src="${BASE_URL}/static/admin/js/edit-book.js"></script>
</body>