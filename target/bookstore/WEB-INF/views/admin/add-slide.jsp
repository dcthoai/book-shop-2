...
<body>
	<h4 class="p-3 ps-lg-0 fs-4 text-light fw-semibold">Banner quảng cáo</h4>
     ...
     <div class="form-add-book mt-4 px-3 px-lg-4 pb-5 rounded">
         <h5 class="mb-4 pt-4 text-center text-md-start">Thêm một banner mới</h5>
         ...
         <div class="row mt-5">
             <div class="col-12 col-lg-8 col-xxl-6 mb-3">
                 ...
                 <input type="text" class="form-control" id="caption" name="title">
             </div>
         </div>
         ...
         <div class="row mt-3">
             <div class="col-12 col-lg-8 col-xxl-6 mb-3">
                 ...
                 <textarea class="form-control" id="content" name="description" rows="6"></textarea>
             </div>
         </div>
         ...
         <div class="row justify-content-center justify-content-md-start">
             <div class="col-auto">
                 ...
                 <button type="button" id="cancel-slide" class="btn btn-danger fw-medium px-4 w-auto">Hủy</button>
             </div>    
         </div>
     </div>

	<script type="text/javascript" src="${BASE_URL}/static/admin/js/add-slide.js"></script>
</body>